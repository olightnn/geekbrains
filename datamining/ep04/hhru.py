...
class HhruSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://nn.hh.ru/search/vacancy?clusters=true&enable_snippets=true&text=python&showClusters=true']
    ...
    def vacancy_parse(self, response: HtmlResponse):
        ...
        print(name, link, salary)
        yield GbparseItem(name=name, salary=salary, link=link, site="hh.ru")
